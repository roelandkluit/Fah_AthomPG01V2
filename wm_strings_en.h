...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<p/>Github <a href='https://github.com/roelandkluit/Fah_AthomPG01V2'>https://github.com/roelandkluit/Fah_AthomPG01V2</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif

const char HTTP_UPDATE[] PROGMEM = "Upload new firmware<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Update</button></form><small><a href='http://192.168.4.1/update' target='_blank'>* May not function inside captive portal, open in browser.</a><small>";
...
const char S_brand[]              PROGMEM = "WiFiManager - Athom PG01";
